    ...
    <div className="bg-white">
            ...
            <>
              <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                ...
                <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                  ...
                  <a
                    href="/signup"
                    className="ml-8 hover:text-white whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:bg-gradient-to-r from-purple-700 to-indigo-700"
                  >
                    Sign up
                  </a>
                </div>
      ...
      <main>
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://i.ibb.co/9NwFZT8/oceanturbines.jpg"
                  alt="Wind turbines"
                />
        ...
        <div className="relative pt-12 pb-32 overflow-hidden">
          <div
            aria-hidden="true"
            className="absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-gray-100"
          />
          <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-8">
            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-12">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">
                      Stay on top of vendor compliance
                    </h2>
              ...
              <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-5">
                  ...
                  <a
                    href="#"
                    class="text-indigo-600 inline-flex items-center font-semibold tracking-wide dark:text-indigo-400"
                  >
                    Read more
                    <svg
        ...
        {/* <div className="bg-gradient-to-r from-purple-800 to-indigo-700">
          <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
            <h2 className="text-3xl font-extrabold text-white tracking-tight">
              Vendor management built for efficiency
            </h2>
        ...
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2024 ARU MSc Computer Science Students. All rights
              reserved.
            </p>
          </div>
        </div>
